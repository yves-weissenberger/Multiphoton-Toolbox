...
def MASK_DRAWER_GUI(areaFile,restart=False,online_trace_extract=0):
    ...
    class Visualizator(QtGui.QMainWindow):
        ...
        def __init__(self, areaFile,online_trace_extract,restart=False):
            ...
            layout.addWidget(grV1,0,0,12,1)
            layout.addWidget(self.histLI,0,1,12,1)

            layout.addWidget(btn1,0,2,1,1)
            layout.addWidget(btn2,0,3,1,1)
            layout.addWidget(btn3,5,2,1,1)
            layout.addWidget(btn4,4,2,1,1)
            layout.addWidget(btn5,3,3,1,1)
            layout.addWidget(btn6,5,3,1,1)
            layout.addWidget(btn7,1,2,1,1)
            layout.addWidget(btn8,1,3,1,1)
            layout.addWidget(btn9,2,2,1,1)
            layout.addWidget(btn10,2,3,1,1)
            layout.addWidget(btn11,3,2,1,1)
            layout.addWidget(btn12,4,3,1,1)
            layout.addWidget(self.Gplt,12,0,1,6)

            #layout.addWidget(self.histLI,0,1,6,1)
